<template>
    <div class="planDate bgG">
      <div class="p-30 font-26" style="background-color: #e1f5fe;">
        <h5>合同编号：BQ18-SH00061-GZ001</h5>
        <h5>项目名称：XXXXXXXXX项目建设一期</h5>
      </div>
      <div class="bgW p-30 m-b-30 flex-box-btew">
        <span>计划时段：03-01 〜 03-30</span>
        <span class="flex-box"><mu-icon value="access_time" class="color_green"/> 历时：22工作日</span>
      </div>
      <div>
